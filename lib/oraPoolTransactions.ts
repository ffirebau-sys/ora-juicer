...
export const ORA_POOL_DEPOSIT_TXN_FEE_MICROALGO = 1_000;
export const ORA_POOL_TOKEN_OPT_IN_MIN_BALANCE_MICROALGO = 100_000;
export const ORA_POOL_TOKEN_OPT_IN_TXN_FEE_MICROALGO = 1_000;
export const ORA_POOL_WITHDRAW_TXN_FEE_MICROALGO = 3_000;
